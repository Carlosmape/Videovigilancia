    ...
    $userdefines = $alldefines['user'];
		...
		<form id="form" class="row" action="" method="post">
			...
			<div class="form-group col-md-6">
				...
				<input class="form-control" type="text" id="dbhost" name="Host" value="<? echo $userdefines['DBHOST'];?>">
				<label for="dbuser" class="sr-only">User</label>User
				<input class="form-control" type="text" id="dbuser" name="User" value="<? echo $userdefines['DBUSER'];?>">
				<label for="dbname" class="sr-only">Database Name</label>Database name
				<input class="form-control" type="text" id="dbname" name="Databasename" value="<? echo $userdefines['DBNAME'];?>">
				<label for="dbpassword" class="sr-only">Password</label>Password
				<input class="form-control" type="text" id="dbpassword" name="Password" value="<? echo $userdefines['DBPASS'];?>">
			</div>
			<div class="form-group col-md-6">
